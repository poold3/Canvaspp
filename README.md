...
Any media that you want to use in the GUI should be placed in the ui directory. When referencing that media, the src/url should be a relative path as if the starting directory was the ui directory. For example, playing smile.png in the references directory would have this src/url: references/smile.png.
### void Start();
